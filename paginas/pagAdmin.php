						...
						<div class="cta-inner text-center rounded">
							...
							<?php
								...
								}else
								{
									...
									echo "<table border='1' style='text-align:center;'><tr><th>Nome</th><th>Senha</th><th>Tipo de Utilizador</th><th>Apagar</th><th>Editar</th><th>Validar</th></tr>";
									// Liga a tabela na base de dados
									$sql = 'SELECT nome,senha,id_tipo_utilizador FROM utilizador WHERE nome!="admin"';
									...
									while($row = mysqli_fetch_array($retval)){// vai buscar ha base de dados os dados nela guardada e poem os na tabela
										...
										echo "<td>".'<a href="pagAdminApagarUser.php?nome='.$row['nome']."\">"."Apagar"."</a>"."</td>";
										echo "<td>".'<a href="pagAdminEditarUser.php?nome='.$row['nome']."\">"."Editar"."</a>"."</td>";
										echo "<td>".'<a href="pagAdminValidarUser.php?nome='.$row['nome']."\">"."Validar"."</a>"."</td>";
										echo "</tr>";
									}
									mysqli_close($conn);
								}
