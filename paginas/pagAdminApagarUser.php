					...
					<div class="col-xl-9 mx-auto">
						...
						<?php
							...
							}else
							{
								...
								// Cria a tabela
								echo "<table border='1' style='text-align:center;'><tr><th>Utilizador à Apagar                                                                     </th></tr>";
								...
								while($row = mysqli_fetch_array($retval)){// vai buscar ha base de dados os dados nela guardada e poem os na tabela
									...
									echo'<form action="pagAdminApagarUserF.php" method="GET">';	
									echo'<input type="text" name="nome" value='.$row['nome'].' size="10"/><br>';
