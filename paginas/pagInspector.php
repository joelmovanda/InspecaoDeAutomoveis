					...
					<div class="col-xl-9 mx-auto">
						...
						<?php
							...
							{	
								...
								// Cria a tabela
								echo "<table border='1' style='text-align:center;'><tr><th>Marcações para Atender</th></tr>";
								echo "<table border='1' style='text-align:center;'><tr><th>Id</th><th>Data</th><th>Hora</th><th>Id_preço</th><th>Utilizador</th><th>Atender</th></tr>";
								
								// Liga a tabela na base de dados
								$sql = "SELECT * FROM marcacao WHERE data='$data' AND hora<='$hora'";
								...
								while($row = mysqli_fetch_array($retval)){// vai buscar ha base de dados os dados nela guardada e poem os na tabela
									...
									echo "<td>".'<a href="pagInspectorAtender.php?id='.$row['id']."\">"."Atender"."</a>"."</td>";
									echo "</tr>";
								}
								mysqli_close($conn);
							}
