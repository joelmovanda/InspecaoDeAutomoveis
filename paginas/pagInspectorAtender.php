					...
					<div class="col-xl-9 mx-auto">
						<div class="cta-inner text-center rounded">
							<h2 class="section-heading mb-5">
								<span class="section-heading-lower">Atendedimento das Marcações</span>
							</h2>
						...
						<?php
							...
							{	
								...
								// Cria a tabela
								echo "<table border='1' style='text-align:center;'><tr><th>Cliente à Atender </th></tr>";
								echo "<table border='1' style='text-align:center;'><tr><th>Id</th><th>Data</th><th>hora</th><th>Preco</th><th>Utilizador</th></tr>";
								...
								while($row = mysqli_fetch_array($retval)){// vai buscar ha base de dados os dados nela guardada e poem os na tabela
									...
									echo'<form action="pagInspectorAtenderF.php" method="GET">';	
										echo'<input type="hidden" name="id" value='.$row['id'].' size="10"/><br>';
										echo'<input type="submit" value="Confirmar"/>';
									echo'</form>';
									
									echo'<form action="pagInspector.php" method="GET">';	
