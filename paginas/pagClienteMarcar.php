				...
				<div class="row">
					<div class="col-xl-9 mx-auto">
						...
						<div class="secundary-button mx-auto">
							<a class="btn btn-primary btn-xl" href="pagLogout.php">Fazer Marção</a>
						</div>
						<?php
							session_start();
							$_SESSION['nome'];
							...
							{	
								...
								// Cria a tabela
								echo "<table border='1' style='text-align:center;'><tr><th>Dados dos Utilizadores</th></tr>";
								echo "<table border='1' style='text-align:center;'><tr><th>Id</th><th>Data</th><th>hora</th><th>Id_Preço</th><th>Utilizador</th></tr>";
								// Liga a tabela na base de dados
								$sql = 'SELECT * FROM marcacao WHERE id_utilizador = $_SESSION["nome"]';
								...
								while($row = mysqli_fetch_array($retval)){// vai buscar ha base de dados os dados nela guardada e poem os na tabela
									...
									echo'<form action="pagClienteMarcarF.php" method="GET">';
									echo'<input type="hidden" name="id" value='.$row['id'].' size="10"/><br>';
									echo'<label>data <input name="data" value='.$row['data'].' size="10"/><br>';
									echo'<label>hora<input name="hora" value='.$row['hora'].' size="10"/><br>';
									echo'<label>preco<input name="catVei" value='.$row['id_preco'].' size="10"/><br>';
									echo'<input type="submit" value="Confirmar"/>';
									echo'</form>';
										
									echo'<form action="pagCliente.php" method="GET">';	
