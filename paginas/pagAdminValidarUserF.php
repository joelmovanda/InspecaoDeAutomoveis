		...
		<nav class="navbar navbar-expand-lg navbar-dark py-lg-4" id="mainNav">
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarResponsive">
					...
					<li class="nav-item px-lg-4">
						<a class="nav-link text-uppercase text-expanded" href="pagAdminDadosPessoais.html">Gestão de dados Pessoais</a>
					</li>
					</ul>
				</div>
			</div>
					...
					<div class="col-xl-9 mx-auto">
						...
						<?php
							...
							{	
								...
								$sql = "UPDATE utilizador SET id_tipo_utilizador='$categ'  WHERE nome='$nome'";
								...
								echo "<br><a href='pagAdmin.php'>Voltar a Pagina Inicial </a>";
							}
						?>
						</div>
					</div>
