			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarResponsive">
					<ul class="navbar-nav mx-auto">
						...
						<a class="nav-link text-uppercase text-expanded" href="pagAdmin.html">Marcações
							<span class="sr-only">(current)</span>
						</a>
					</li>
					<li class="nav-item px-lg-4">
						<a class="nav-link text-uppercase text-expanded" href="pagAdminPessoal.html">Gestão  Pessoal</a>
					</li>
					</ul>
				</div>
			</div>
					...
					<div class="col-xl-9 mx-auto">
						...
						<?php
							...
							{	
								...
								$sql = "UPDATE marcacao SET data='$data',hora='$hora',id_preco='$categ' WHERE id='$id'";
