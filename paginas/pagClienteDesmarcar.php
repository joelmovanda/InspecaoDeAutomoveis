                ...
                <span class="section-heading-lower">Marcações </span>
						...
						<?php
							...
							{	
								...
								echo "<table border='1' style='text-align:center;'><tr><th>Id</th><th>Data</th><th>hora</th><th>Categoria</th><th>Utilizador</th></tr>";
								...
								while($row = mysqli_fetch_array($retval)){// vai buscar ha base de dados os dados nela guardada e poem os na tabela
									...
									echo'<form action="pagClienteDesmarcarF.php" method="GET">';	
