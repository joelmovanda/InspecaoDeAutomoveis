					...
					<div class="col-xl-9 mx-auto">
						<div class="cta-inner text-center rounded">
							<h2 class="section-heading mb-5">
								<span class="section-heading-lower">Centro de Inpeção de Automóvel</span>
							</h2>
							<?php
								// Ligar há base de dados
								include '../basedados/basedados.h';
								echo "<table border='1' style='text-align:center;'><tr><th>Id</th><th>Localização</th><th>Horario</th><th>Preço</th></tr>";
								// Liga a tabela na base de dados
								$sql = 'SELECT *FROM centro_inspecao AS Ci INNER JOIN categoria_veiculo AS cv 
										ON ci.id_preco=cv.id';
