						...
						<div class="cta-inner text-center rounded">
							...
							<?php
								...
								else
								{
									...
									// Cria a tabela
									echo "<table border='1' style='text-align:center;'><tr><th>Altera à Marcação</th></tr>";
									// Liga a tabela na base de dados
									$sql = "SELECT * FROM marcacao WHERE id='$id'";
									...
									{// vai buscar ha base de dados os dados nela guardada e poem os na tabela
										
										
										echo'<form action="pagAdminAlterarMarcacaoF.php" method="GET">';
										...
										echo'<label>Categoria<input name="categ" value='.$row['id_preco'].' size="10"/><br>';
										echo'<input type="submit" value="Confirmar"/>';
										echo'</form>';
										
										echo'<form action="pagAdminMarcacao.php" method="GET">';	
