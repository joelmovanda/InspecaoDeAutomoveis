					...
					<div class="col-xl-9 mx-auto">
						...
						<?php
							...
							{	
								...
								// Cria a tabela
								echo "<table border='1' style='text-align:center;'><tr><th>Altera à Dados Pessoais                               </th></tr>";
								...
								while($row = mysqli_fetch_array($retval)){// vai buscar ha base de dados os dados nela guardada e poem os na tabela
									...
									echo'<form action="pagInspectorAlterarDadosPessoaisF.php" method="GET">';
									echo'<input type="hidden" name="nome" value='.$row['nome'].' size="10"/><br>';
									...
									echo'<form action="pagInspectorDadosPessoais.php" method="GET">';	
